...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/JSPMyAdmin";
...
<center style="text-align: center;"><%=t%></center>
 <form action="/JSPMyAdmin/Main.jsp" method="post" name="login" onSubmit="return validate(this)">
<table align=center bgcolor="#f5f5f5" style="width: 316px; height: 100px">
            <tr>
                <td style="width: 184px;">
                    Username</td>
                <td style="width: 5px">
                <input type="text" name="user" style="width: 226px" value="root"></td>
  ...
  Server
                ...
                <td style="width: 5px">
                <input type="text" name="server" style="width: 227px" value="localhost"></td>
  ...
  Port</td>
                ...
                <input type="text" name="port" style="width: 226px" value="3306"></td>
