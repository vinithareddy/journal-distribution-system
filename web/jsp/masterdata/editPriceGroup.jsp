<%--
    Document   : Edit Journal Price Group
    Author     : Deepali
--%>
...
<html>
    <head>
        ...
        <title>Edit Journal Price Group</title>
        <script type="text/javascript" src="js/masterdata/editPriceGroup.js"></script>
        <script>
            ...
            <form method="post" action="<%=request.getContextPath() + "/priceGroup"%>" name="priceGroupForm">
                <div class="MainDiv">
                    <fieldset class="MainFieldset">
                        <legend>Edit Journal Price Group</legend>
