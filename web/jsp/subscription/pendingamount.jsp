                ...
                <fieldset class="MainFieldset">
                    ...
                    <fieldset class="subMainFieldSet">
                        <div class="actionBtnDiv">
                            <input class="IASButton" id="btnPrint" value="Print" type="button" onclick="jdsPrint('print/inward/' + $('#inwardNumber').val() + '/opb', 'Pending Amount')"/>
                            <%
                            ...
                            %>
                            <input class="IASButton" id="btnEmail" value="Email" type="button" <%=isDisabled%> onclick="jdsEmail('email/inward/' + $('#inwardNumber').val() + '/opb')"/>
                        </div>
                    </fieldset>
                </fieldset>
            </div>
