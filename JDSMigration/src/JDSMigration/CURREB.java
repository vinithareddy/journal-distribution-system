 ...
 * @author Shailendra
 */
public class CURREB extends MigrationBase{

    private static final Logger logger = Logger.getLogger(CURREB.class.getName());

    public CURREB() throws SQLException, IOException, BiffException {
        this.dataFile = this.dataFolder + "\\CURREB.xls";
