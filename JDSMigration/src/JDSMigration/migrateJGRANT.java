 ...
 * @author aloko
 */
public class migrateJGRANT extends MigrationBase{

    private static final Logger logger = Logger.getLogger(migrateJGRANT.class.getName());
        ...
        public migrateJGRANT() throws SQLException {
        this.dataFile = this.dataFolder + "\\JGRANT.xls";
    ...
    public void Migrate() throws FileNotFoundException, IOException, BiffException, SQLException {
        ...
        while (true) {
            ...
            // Extract data
            String agentCode    = "0";
            String subtype      = "GRANT";
            String subscriberName   = datacolumns[0];
            String department       = datacolumns[1];
            String institution      = datacolumns[2];
            String shippingAddress      = datacolumns[3] +  " " + datacolumns[4];
            String cityAndPin   = datacolumns[5];
            String pincode      = datacolumns[7];
            String state        = datacolumns[6];
            String country      = "";
            String email        = "";
