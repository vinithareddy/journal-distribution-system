...
insert into `subscriber_type`(`subtypecode`,`subtypedesc`,`subtype`,`nationality`,`institutional`,`freejrnl`,`discount`) values ('LSP','Life Subscriber Personal','Free','I','P',0,0);
insert into `subscriber_type`(`subtypecode`,`subtypedesc`,`subtype`,`nationality`,`institutional`,`freejrnl`,`discount`) values ('LSI','Life Subscriber Institutions','Free','I','I',0,0);
