...
public class JDSConstants {
    ...
    public static String IAS_LETTERHEAD_TELEPHONE = "Phone: +91-80-2266 1200, FAX: +91-80-2361 6094";
    public static String IAS_LETTERHEAD_EMAIL = "E-mail: office@ias.ernet.in";
    ...
    public static String IAS_LETTERFOOT_CLOSING = "Your's Truly";
