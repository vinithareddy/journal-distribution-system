 ...
 * @author smahapat
 */
public class ConfirmedPaymentAcknowledgment extends InwardAcknowledgement {

    public ConfirmedPaymentAcknowledgment() throws IOException {
        //super();
    }
    ...
    public String getAcknowledgementText(int inwardPurposeID, int paymentModeID, String cheque, String chequeDate, float amount, String letterNo, String letterDate) {
        ...
        if (amount > 0) {
            _text = String.format(this.getPropertyFile().getProperty("confirmed_payment_ack"), paymentModeText, cheque, chequeDate, amount);
