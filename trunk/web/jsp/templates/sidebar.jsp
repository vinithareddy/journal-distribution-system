...
<div id="sidebar" class="sdmenu">
    ...
    <div class="collapsed">
        ...
        <a tabindex="-1" href="<%=contextPath + "/main?action=gcreatesubscriber"%>">Create Subscriber</a>
    ...
    <div class="collapsed">
        ...
        <a tabindex="-1" href="<%=contextPath + "/addMasterData?action=addSubType"%>">Add New Subscriber Type</a>
