        ...
        <script type="text/javascript">
                ...
                $("#dialog").dialog({
                    ...
                    buttons: {
                        "Select": function () {
                            ...
                            // call this function from the subscriberlist.jsp which is included under div id=dialog
            ...
            $(function () {
                $("#btnSearchSubscriber")
                        ...
                        .click(function () {
                            // open the search subscriber dialog
                            $("#dialog").dialog('open');
                            searchSubscriber();
                            return false;
                        });
                    ...
                    <div>
                        <div class="IASFormLeftDiv">
                            ...
                            <span class="IASFormDivSpanInputBox">
                                ...
                                <button class="IASButton" type="button" id="btnSearchSubscriber" TABINDEX="2">Search</button>
                                <button class="IASButton" type="button" id="btnCreateSubscriber" TABINDEX="3">Create Subscriber</button>
                            </span>                            
                        </div>
                        <div class="IASFormRightDiv">
                            <span class="IASFormDivSpanLabel">
