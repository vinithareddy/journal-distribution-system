    ...
    <head>
        ...
        <div id="bodyContainer">
            <div class="MainDiv">
                ...
                <iframe id="form-iframe" style="width: 100%; height: 80%;" frameborder="1" scrolling="yes" src="print/inward/<%=inwardNumber%>/rfi"></iframe>
                <fieldset class="subMainFieldSet">
                    <div class="actionBtnDiv">
                        ...
                        %>
                        <input class="IASButton" id="btnEmail" value="Email" type="button" <%=isDisabled%> onclick="jdsEmail('email/inward/<%=inwardNumber%>/rfi')"/>
                    </div>
                </fieldset>
                </fieldset>
            </div>
