...
public class main extends JDSController {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equalsIgnoreCase("home")) {
            ...
            url = "/jsp/inward/gatekeeperinward.jsp?nextAction=renewsubscription&inwardPurpose=Renew Subscription&next="
                  + request.getContextPath() + "/jsp/subscription/addnewsubscription.jsp";
        } else if (action.equalsIgnoreCase("missingissue")) {
            url = "/jsp/inward/gatekeeperinward.jsp?nextAction=missingissue&inwardPurpose=Missing Issue&next="
                  + request.getContextPath() + "/jsp/missingissue/missingissuelist.jsp";
            ...
            url = "/jsp/inward/gatekeeperinward.jsp?nextAction=addresschange&inwardPurpose=Address Change&next="
                  + request.getContextPath() + "/jsp/subscriber/editsubscriber.jsp";
            ...
            url = "/jsp/inward/gatekeeperinward.jsp?nextAction=gpi&inwardPurpose=Request For Invoice&next="
                  + request.getContextPath() + "/jsp/invoice/proforma.jsp";
        ...
        if (url == null) {
            ...
            if ((request.getSession() != null)
                    && (request.getSession(false).getAttribute("inwardUnderProcess") != null)) {
