...
public class SubscriptionController extends JDSController {
    ...
    public SubscriptionController(HttpServletRequest req, HttpServletResponse resp, ServletContext context, String[] params) {
        this.req = req;
        this.resp = resp;
    ...
    public void actionDupcheck() {
        ...
        try {
            ...
            List<Integer> duplicate_journal_grp_ids = subscriptionModel.getDuplicateSubscription(subscriber_id, journal_grp_ids, start_years, start_months);
