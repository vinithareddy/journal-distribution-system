...
insert into `journals`(`journalCode`,`journalName`,`issnNo`,`startYear`) values ('EPS','Journal of Earth System Science','0253-4126',1991);
insert into `journals`(`journalCode`,`journalName`,`issnNo`,`startYear`) values ('CS','Journal of Chemical Sciences','0253-4134',2000);
